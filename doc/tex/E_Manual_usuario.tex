...
\imagen{mu-1}{Interfaz con los campos de inicio de sesión}{1}
\imagen{mu-2}{Interfaz con el registro}{1}
\imagen{mu-3}{Interfaz con la contraseña <<a la vista>>}{1}
\imagen{mu-4}{Interfaz con mensajes de error}{0.6}
...
\imagen{mu-5}{Interfaz con selección de revistas}{1}
\imagen{mu-6}{Interfaz con selección de modelos}{0.7}
\imagen{mu-7}{Icono de listado de revistas}{0.1}
\imagen{mu-8}{Tooltip que aconseja rellenar todos los campos}{0.9}
...
\imagen{mu-9}{Interfaz con el histórico del JCR}{1}
...
\imagen{mu-10}{Interfaz con la predicción del JCR}{1}
...
\imagen{mu-11}{Interfaz con el listado de revistas}{1}
\imagen{mu-12}{Interfaz con la información adicional de una revista}{1}
...
\imagen{mu-13}{Interfaz con los datos del usuario}{1}
\imagen{mu-14}{Interfaz con edición de los datos de usuario}{1}
...
\imagen{mu-15}{Barra de navegación con menú desplegable de usuario}{1}
\imagen{mu-16}{Barra de navegación con menú desplegable de idiomas}{1}
\imagen{mu-17}{Barra inferior de la aplicación}{1}
\imagen{mu-18}{Breadcrums}{0.6}
\imagen{mu-19}{Responsividad frente al cambio de tamaño de pantalla}{0.5}