...
% NOTA: Modificaciones hechas por la alumna.
\newcommand{\tablaSmall}[5]{%
 \begin{table}
  \begin{center}
   \rowcolors {2}{gray!35}{}
   % Modificado: ajuste del sobrayado gris a los márgenes
   \setlength{\tabcolsep}{0pt}
   % Modificado:@{} elimina los espacios laterales
   \begin{tabular}{#2}
    \toprule
    #4
    \otoprule
...
\noindent Dña. Virginia Ahedo, profesora del departamento de Ingeniería de Organización, área de Organización de Empresas y D. Álvar Arnaiz, del departamento de Ingeniería Informática, área de Lenguajes y Sistemas Informáticos.
