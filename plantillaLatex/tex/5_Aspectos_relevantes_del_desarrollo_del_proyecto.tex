...
\imagen{diagrama_cajas}{Dispersión de los datos extraídos en función del año}{1}
...
\imagen{pipeline}{Conjunto inicial de los datos}{1}
...
\imagen{mse}{Estimación del RMSE de los modelos entrenados}{0.7}
\imagen{desviacion.png}{Desviación de las estimaciones}{0.8}
