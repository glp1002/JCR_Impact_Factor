...
\section{Aplicaión web}
En el proyecto se ha utilizado Python, tal como se ha mencionado en apartados anteriores, como lenguaje principal de desarrollo. Para la creación de la aplicación web, se ha optado por utilizar Flask, un \textit{framework} ligero y flexible que facilita la construcción de aplicaciones web en Python. Además de Python y Flask, se han empleado otros lenguajes como HTML, CSS y JavaScript para desarrollar las interfaces de usuario y dotarlas de funcionalidades interactivas. 

Asimismo, se ha utilizado la biblioteca psycopg2 de Python, la cual ha sido fundamental para establecer la comunicación con la base de datos tipo PostgreSQL. Esta biblioteca proporciona una interfaz eficiente y robusta para interactuar con la base de datos, permitiendo realizar operaciones de consulta, inserción, actualización y eliminación de datos de manera segura y eficiente.

Para la internacionalización de la aplicación, se ha empleado Babel. Se trata de una herramienta de localización y traducción que permite adaptar la aplicación web a diferentes idiomas y culturas. De esta forma, se han implementado funcionalidades que facilitan la traducción de los elementos visuales y textuales de la aplicación, permitiendo que los usuarios puedan acceder y utilizar la aplicación en cualquiera de los siguientes idiomas: español, inglés o francés.

\section{APIs externas}
A lo largo del proyecto se ha recurrido a varias APIs diferentes para la fase de extracción de datos. A continuación, se enumeran aquellas de acceso gratuito con las que se ha podido trabajar.
