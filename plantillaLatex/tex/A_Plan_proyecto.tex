...
\tabla{Sprint 13}{llll}{4}{sprint13}{\textbf{Sprt.} & \textbf{Duración} & \textbf{Objetivos} & \textbf{Tareas}\\}{
    9 & \parbox{55}{15/05/2023 22/05/2023} & \parbox{80}{Lanzar la aplicación en Heroku y mejora de funcionalidades.} & \parbox{150}{\begin{itemize}\item Serie temporal \item Añadir el cuartil a las revistas \item  Configurar API en Heroku \item Configuarar BBDD en Heroku\end{itemize}}\\
}
